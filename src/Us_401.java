...
public class Us_401 extends BaseDriver {
    ...
    public void urlControl(){
        driver.get("https://www.akakce.com/akakcem/Sefa");
        MyFunc.Wait(1);

        WebElement control=driver.findElement(By.cssSelector("[jsselect='heading']"));
        Assert.assertTrue("Giriş başarılı",control.getText().contains("www.akakce.com ana makinesine erişim reddedildi"));
        MyFunc.Wait(1);
